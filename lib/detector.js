...
Detector.prototype.detect = function(timeout,bindaddr) {
...
Detector.findAny = function(timeout, bindaddr, callback) {
    ...
    detector.detect(timeout,bindaddr);
};

Detector.find = function(address, timeout, bindaddr, callback) {
    var detector = new Detector();
